...
sigma3 = zeros(m,num_labels);

for t = 1 : m
    %step1
   a1 = X(t,:);
   a1 = a1';
   z2 = Theta1*a1; % 25x401 * 401x10 -> 25x1
   a2 = sigmoid(z2);    % 25x1
   a2 = [1; a2];        % 26x1
   ...
   %step3
   z2 = [1;z2];
   sigma2 = Theta2'*sigma3.*sigmoidGradient(z2); %  26x10 * 10x1 .* 26x1 -> 26x1
   %step 4
   sigma2 = sigma2(2:end);
   Theta2_grad = Theta2_grad + sigma3*a2'; % 10x1 * 1x26 -> 10x26
   Theta1_grad = Theta1_grad + sigma2*a1'; % 26x1 * 1x401 -> 25x401
end
